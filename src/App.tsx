...
import GameModal from '@components/GameModal'; // [NEW] Импорт модалки
...
function App() {
  ...
  // [NEW] Состояние для выбранной игры (модалка)
  ...
  // [NEW] Хендлеры для открытия/закрытия модалки
          ...
          <section className="games-grid-section">
            <Suspense fallback={<LoadingSkeleton />}>
              {filteredGames.length > 0 ? (
                <GameGrid 
                   games={filteredGames} 
                   onOpenModal={handleOpenModal} /* [NEW] Передали функцию */
                />
              ) : (
